...
T_void
TextSetFont(T_textID textID, T_byte8 *fontname)
{
    T_textStruct *p_text;
    T_resourceFile res;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
TextDrawCallBack(T_graphicID graphicID, T_word16 index)
{
...
T_graphicID
TextGetGraphicID(T_textID textID)
{
    T_textStruct *p_text;
...
T_void
TextSetText(T_textID textID, const T_byte8 *string)
{
    T_textStruct *p_text;
    T_graphicStruct *p_graphic;
    T_bitfont *p_font;
    ...
    p_graphic->width = 0;
    for (i = 0; i < len; i++)
        p_graphic->width += GrGetCharacterWidth(p_text->data[i]);
...
T_void
TextSetColor(T_textID textID, T_byte8 fc, T_byte8 bc)
{
    T_textStruct *p_text;
...
T_void
TextMoveText(T_textID textID, T_word16 x, T_word16 y)
{
    T_textStruct *p_text;
    T_graphicStruct *p_graphic;
...
T_void
TextCleanString(T_byte8 *stringToClean)
{
    T_word16 len, i;
