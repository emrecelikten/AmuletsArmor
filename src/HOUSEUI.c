...
static T_void
HouseUILeaveGame(T_buttonID buttonID);

T_void
HouseUIStart(T_word32 formNum)
{
    T_word16 i;
    T_byte8 stmp[32];
...
T_void
HouseRequestInfoPackage(T_word32 formNum)
{
...
T_void
HouseRequestHouseInventory(T_void)
{
    T_graphicID tempGraphic;
...
T_void
HouseChangeStatus(T_buttonID buttonID)
{
    T_byte8 stmp[32];
