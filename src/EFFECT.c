...
static T_void
EffectAddPlayerEffect(T_word16 data1,
                      T_word16 data2,
                      T_word16 data3,
                      T_void *p_owner);

static T_void
EffectRemovePlayerEffect(T_void *p_owner);

static E_Boolean
EffectDestroyElement(T_doubleLinkListElement killme);

static T_void
EffectStartPlayerEffect(T_playerEffectStruct *p_effect);
static T_void
EffectStopPlayerEffect(T_playerEffectStruct *p_effect);
 ...
 *<!-----------------------------------------------------------------------*/
E_Boolean
Effect(E_effectType effecttype,
...
//        OverlaySetAnimation (data1);
            if (data2 == 0)
                StatsSetWeaponBaseDamage(2);
            else
                StatsSetWeaponBaseDamage((T_sbyte8) data2);
            ...
            if (p_inv != NULL)
            {
                ...
                if (((T_word32) ObjectGetScriptHandle(p_inv->object)) < 100 && (data2 != 0)
                    && (G_effectSoundOn == TRUE))
                {
                    switch (p_inv->itemdesc.subtype)
                    {
                        case EQUIP_WEAPON_TYPE_DAGGER:ClientSyncSendActionAreaSound(SOUND_SHEATH_DAGGER, 500, FALSE);
                            //SoundPlayByNumber (SOUND_SHEATH_DAGGER,255);
                            break;

                        case EQUIP_WEAPON_TYPE_LONGSWORD:
                            ClientSyncSendActionAreaSound(SOUND_SHEATH_LONGSWD,
                                                          500,
                                                          FALSE);
                        ...
                        case EQUIP_WEAPON_TYPE_SHORTSWORD:
                            ClientSyncSendActionAreaSound(SOUND_SHEATH_SHTSWD,
                                                          500,
                                                          FALSE);
        ...
        case EFFECT_TAKE_COIN: StatsAddCoin(data1, data2);
            break;
        ...
        case EFFECT_ADD_PLAYER_EFFECT:EffectAddPlayerEffect(subtype, duration, power, p_owner);
            break;

        case EFFECT_REMOVE_PLAYER_EFFECT:EffectRemovePlayerEffect(p_owner);
            break;

        case EFFECT_MOD_PLAYER_FOOD:StatsChangePlayerFood((T_sword16) power);
            break;

        case EFFECT_MOD_PLAYER_WATER:StatsChangePlayerWater((T_sword16) power);
            break;

        case EFFECT_MOD_PLAYER_HEALTH:StatsChangePlayerHealth((T_sword16) power);
            break;

        case EFFECT_MOD_PLAYER_MANA:StatsChangePlayerMana((T_sword16) power);
            break;

        case EFFECT_MOD_PLAYER_EXPERIENCE:StatsChangePlayerExperience((T_sword16) power);
            break;
...
//        PlayerSetAngle(rand()) ;
        ...
        case EFFECT_PLAYER_LEAP:PlayerJump(StatsGetJumpPower() + power);
...
//            SoundPlayByNumber (1001,255);
        ...
        case EFFECT_SET_PLAYER_BEACON:break;

        case EFFECT_RETURN_TO_PLAYER_BEACON:break;

        case EFFECT_ADD_RUNE:SpellsSetRune((E_spellsRuneType) subtype);
            break;

        case EFFECT_REMOVE_RUNE:SpellsClearRune((E_spellsRuneType) subtype);
            break;

        case EFFECT_MOD_PLAYER_HEALTH_RANDOM:StatsChangePlayerHealth((T_sword16) power + (T_sword16) rand() % power);
            break;

        case EFFECT_MOD_PLAYER_MANA_RANDOM:StatsChangePlayerMana((T_sword16) power + (T_sword16) rand() % power);
            break;

        case EFFECT_MOD_PLAYER_POISON_LEVEL:StatsChangePlayerPoisonLevel((T_sbyte8) power);
            if ((T_sbyte8) power < 0)
                break;
...
//          SoundPlayByNumber (2001,255);
        ...
        case EFFECT_DISPLAY_CANNED_MESSAGE:MessageDisplayMessage((T_word16) subtype);
            break;
...
//              SoundPlayByNumber (4013,255);
        ...
        case EFFECT_TRIGGER_EARTHQUAKE:MessageAdd("^003The ground shakes around you!!");
            ViewEarthquakeOn((T_word32) duration);
            break;

        case EFFECT_REMOVE_RANDOM_SPELL:MessageAdd("^003The air crackles around you!");
            ClientSyncSendActionAreaSound(2001, 500, FALSE);
            EffectRemoveRandomPlayerEffect();
            break;

        case EFFECT_TAKE_NORMAL_DAMAGE:StatsTakeDamage(EFFECT_DAMAGE_NORMAL, (T_word16) power);
            break;

        case EFFECT_TAKE_FIRE_DAMAGE:StatsTakeDamage(EFFECT_DAMAGE_FIRE, (T_word16) power);
            break;

        case EFFECT_TAKE_ACID_DAMAGE:StatsTakeDamage(EFFECT_DAMAGE_ACID, (T_word16) power);
            break;

        case EFFECT_TAKE_POISON_DAMAGE:StatsTakeDamage(EFFECT_DAMAGE_POISON, (T_word16) power);
            break;

        case EFFECT_TAKE_ELECTRICITY_DAMAGE:StatsTakeDamage(EFFECT_DAMAGE_ELECTRICITY, (T_word16) power);
            break;

        case EFFECT_TAKE_PIERCING_DAMAGE:StatsTakeDamage(EFFECT_DAMAGE_PIERCING, (T_word16) power);
            break;

        case EFFECT_TAKE_MANA_DRAIN_DAMAGE:StatsTakeDamage(EFFECT_DAMAGE_MANA_DRAIN, (T_word16) power);
            break;

        case EFFECT_TAKE_MULTIPLE_DAMAGE:StatsTakeDamage((T_word16) subtype, (T_word16) power);
            break;
...
//           ClientCreateProjectile(data1, data2, data2);
        ...
        case EFFECT_FIRE_BOLT:bolttype = BannerGetSelectedAmmoType();
        ...
        case EFFECT_COLOR_FLASH:ColorAddGlobal((T_sbyte8) data1, (T_sbyte8) data2, (T_sbyte8) data3);
            break;

        case EFFECT_JUMP_FORWARD:PlayerJumpForward(data3);
            ColorAddGlobal(0, 0, 20);
//        SoundPlayByNumber (2004,255);
            ClientSyncSendActionAreaSound(2004, 500, FALSE);
            break;

        case EFFECT_ADD_JOURNAL_PAGE_BY_OBJECT:p_object = (T_3dObject *) p_owner;
        ...
        case EFFECT_ADD_JOURNAL_PAGE:p_object = (T_3dObject *) p_owner;
...
//            SoundPlayByNumber (2010,255);
        ...
        case EFFECT_IDENTIFY_READIED:ColorAddGlobal(0, 0, 20);
            ClientSyncSendActionAreaSound(2001, 500, FALSE);
            InventoryIdentifyReadied();
            MessageAdd("^009You understand your equipment better!");
            break;

        case EFFECT_IDENTIFY_ALL:ColorAddGlobal(0, 0, 30);
            ClientSyncSendActionAreaSound(2001, 500, FALSE);
...
EffectPlayerEffectIsActive(E_playerEffectType type)
{
    ...
    if (G_playerEffectPowers[type] > 0)
        retvalue = TRUE;
...
//            SoundPlayByNumber (2000,255);
        ...
        case PLAYER_EFFECT_STRENGTH_MOD:
            ...
            {
                if (power > 0)
                    MessageAdd("^009You feel a surge of strength!");
//            SoundPlayByNumber (2001,255);
                ClientSyncSendActionAreaSound(2001, 500, FALSE);
                ColorAddGlobal(20, 0, 20);
            }
        ...
        case PLAYER_EFFECT_ACCURACY_MOD:
            ...
            {
                if (power > 0)
                    MessageAdd("^009Your senses sharpen and things come into focus.");
//            SoundPlayByNumber (2001,255);
                ClientSyncSendActionAreaSound(2001, 500, FALSE);
                ColorAddGlobal(20, 0, 20);
            }
        ...
        case PLAYER_EFFECT_SPEED_MOD:
            ...
            {
                if (power > 0)
                    MessageAdd("^009The world seems to be moving more slowly about you.");
                ColorAddGlobal(20, 0, 20);
//            SoundPlayByNumber (2001,255);
                ClientSyncSendActionAreaSound(2001, 500, FALSE);
            }
        ...
        case PLAYER_EFFECT_CONSTITUTION_MOD:
            ...
            {
                if (power > 0)
                    MessageAdd("^009You feel hardier!");
                ColorAddGlobal(20, 0, 20);
//            SoundPlayByNumber (2001,255);
                ClientSyncSendActionAreaSound(2001, 500, FALSE);
            }
        ...
        case PLAYER_EFFECT_MAGIC_MOD:
            ...
            {
                if (power > 0)
                    MessageAdd("^009Your mind clears and you feel more focused");
                ColorAddGlobal(20, 0, 20);
//            SoundPlayByNumber (2001,255);
                ClientSyncSendActionAreaSound(2001, 500, FALSE);
            }
        ...
        case PLAYER_EFFECT_STEALTH_MOD:
            ...
            {
                if (power > 0)
                    MessageAdd("^009You feel like you are being watched");
//            SoundPlayByNumber (2001,255);
                ClientSyncSendActionAreaSound(2001, 500, FALSE);
                ColorAddGlobal(20, 0, 20);
            }
...
EffectStopPlayerEffect(T_playerEffectStruct *p_effect)
{
    ...
    {
        case PLAYER_EFFECT_INVULNERABLE:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The feeling of invulnerability passes.");
            break;

        case PLAYER_EFFECT_FLY:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014You feel gravity once again take hold.");
            break;
        ...
        case PLAYER_EFFECT_LAVA_WALK:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014Your feet no longer feel cold.");
            break;

        case PLAYER_EFFECT_WATER_WALK:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014Your feet no longer feel warm.");
            break;

        case PLAYER_EFFECT_FEATHER_FALL:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The feeling of lightheadedness passes.");
            break;

        case PLAYER_EFFECT_STICKY_FEET:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014Your feet no longer stick to everything.");
            break;

        case PLAYER_EFFECT_SHOCK_ABSORB:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014You are once again afraid of high places.");
            break;
        ...
        case PLAYER_EFFECT_RESIST_ELECTRICITY:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014You no longer feel protected.");
            break;

        case PLAYER_EFFECT_SHIELD:G_playerEffectPowers[type] -= power;
            StatsCalcAverageArmorValue();
        ...
        case PLAYER_EFFECT_STRENGTH_MOD:
            if (power > 0)
                MessageAdd("^014You feel somewhat weaker.");
            StatsChangePlayerAttributeMod(ATTRIBUTE_STRENGTH, -(T_sbyte8) power);
            break;

        case PLAYER_EFFECT_ACCURACY_MOD:
            if (power > 0)
                MessageAdd("^014You feel clumsier.");
            StatsChangePlayerAttributeMod(ATTRIBUTE_ACCURACY, -(T_sbyte8) power);
            break;

        case PLAYER_EFFECT_SPEED_MOD:
            if (power > 0)
                MessageAdd("^014Hmm... everything sped up for some reason.");
            StatsChangePlayerAttributeMod(ATTRIBUTE_SPEED, -(T_sbyte8) power);
            break;

        case PLAYER_EFFECT_CONSTITUTION_MOD:
            if (power > 0)
                MessageAdd("^014You feel somewhat weakened.");
            StatsChangePlayerAttributeMod(ATTRIBUTE_CONSTITUTION, -(T_sbyte8) power);
            break;

        case PLAYER_EFFECT_MAGIC_MOD:
            if (power > 0)
                MessageAdd("^014The feeling of mental acuity passes.");
            StatsChangePlayerAttributeMod(ATTRIBUTE_MAGIC, -(T_sbyte8) power);
            break;

        case PLAYER_EFFECT_STEALTH_MOD:
            if (power > 0)
                MessageAdd("^014The jittery feeling passes.");
            StatsChangePlayerAttributeMod(ATTRIBUTE_STEALTH, -(T_sbyte8) power);
            break;

        case PLAYER_EFFECT_HEALTH_REGEN_MOD:
            if (power > 0)
                MessageAdd("^014You feel different somehow.");
            StatsChangePlayerHealthRegen(-(T_sword16) power);
            break;
        ...
        case PLAYER_EFFECT_INVISIBLE:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The airy feeling passes.");
            break;

        case PLAYER_EFFECT_NIGHT_VISION:ViewSetDarkSight(0);
            break;
        ...
        case PLAYER_EFFECT_MOD_JUMP_POWER:MessageAdd("^014Your legs feel weaker.");
            StatsModJumpPower(-(T_sword16) power);
            break;
        ...
        case PLAYER_EFFECT_ETERNAL_NOURISHMENT:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014You no longer feel sustained.");
            break;

        case PLAYER_EFFECT_POISON_ATTACK:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The green mist surrounding your hands fades.");
            break;

        case PLAYER_EFFECT_ELECTRICITY_ATTACK:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The yellow aura dissipates.");
            break;

        case PLAYER_EFFECT_PIERCING_ATTACK:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The blue aura dissipates.");
            break;

        case PLAYER_EFFECT_MANA_DRAIN_ATTACK:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The purple liquid dries up from your fingertips.");
            break;

        case PLAYER_EFFECT_FIRE_ATTACK:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014Your hands stop glowing red.");
            break;

        case PLAYER_EFFECT_ACID_ATTACK:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The white froth on your hands disappears.");
            break;

        case PLAYER_EFFECT_WATER_BREATHING:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The warm feeling subsides.");
            break;

        case PLAYER_EFFECT_DEATH_WARD:
            if (G_playerEffectPowers[type] == 1)
                MessageAdd("^014The energy surge wears off.");
            break;
