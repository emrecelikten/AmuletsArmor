...
static T_void
IStartUpGenerator(T_objectGenerator *p_generator);

static T_void
IDestroyGenerator(T_objectGenerator *p_generator);

static T_void
IGeneratorGenerate(T_objectGenerator *p_generator);

static T_objectGenerator *
IFindGenerator(T_word16 genID);
 ...
 *<!-----------------------------------------------------------------------*/
T_void
ObjectGeneratorLoad(T_word32 mapNumber)
{
    FILE *fp;
    T_byte8 filename[20];
    T_byte8 line[80];
...
IGeneratorGenerate(T_objectGenerator *p_generator)
{
    ...
    SyncMemAdd("Gen stats %d %d %d\n",
               ...
               ObjectsCountType(p_generator->objectType),
               ObjectsCountBasicType(p_generator->objectType));
 ...
 ****************************************************************************/
T_void
ObjectGeneratorActivate(T_word16 genID)
{
    T_objectGenerator *p_gen;
 ...
 ****************************************************************************/
T_void
ObjectGeneratorDeactivate(T_word16 genID)
{
    T_objectGenerator *p_gen;
 ...
 ****************************************************************************/
T_objectGeneratorHandle
ObjectGeneratorCreateHandle(T_void)
{
 ...
 ****************************************************************************/
T_void
ObjectGeneratorDestroyHandle(T_objectGeneratorHandle handle)
{
 ...
 ****************************************************************************/
T_void
ObjectGeneratorSetHandle(T_objectGeneratorHandle handle)
{
    T_objectGeneratorHandleStruct *p_handle;
 ...
 ****************************************************************************/
T_void
ObjectGeneratorGetHandle(T_objectGeneratorHandle handle)
{
    T_objectGeneratorHandleStruct *p_handle;
