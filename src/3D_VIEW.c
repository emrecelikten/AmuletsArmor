...
/* Internal prototypes: */
E_Boolean
IIsSegmentGood(T_word16 segmentIndex);
T_void
ICalculateWallMatrix(T_void);
T_void
IMarkOffWall(T_void);
T_void
IAddMainWall(T_void);
T_void
IAddLowerWall(T_void);
T_void
IAddUpperWall(T_void);
T_byte8 *
IDetermineShade(T_sword32 distance, T_word16 shadeStart);
T_void
...
static T_void
IAddVertFloor(T_word16 x, T_sword16 top, T_sword16 bottom, T_word16 sector);
T_void
IDumpVertFloor(T_void);
T_void
IDrawFloorRun(T_word16 y, T_horzFloorInfo *p_floor);
static T_void
IConvertVertToHorzAndDraw(T_void);
static T_void
IAddChainedObjects(T_void);
static T_void
IAddChainedObject(T_3dObject *p_obj);
T_byte8
View3dOnRightByNodeWithXY(
    T_word16 nodeIndex,
    T_sword16 x,
    T_sword16 y);
...
static T_void
IDrawWallSliceColumn(T_3dWallSlice *p_slice);
/* ---------------- ---- ----- ------- ------------------ */
...
/* Internal prototypes: */
T_byte8
View3dRightSideInCone(T_word16 nodeIndex);
T_byte8
View3dLeftSideInCone(T_word16 nodeIndex);
T_byte8
View3dOnRightByVertices(T_word16 from, T_word16 to);
T_byte8
View3dOnRightByVerticesXY(
    T_word16 from,
    T_word16 to,
    T_sword16 x,
    T_sword16 y);
T_byte8
View3dOnRightByNode(T_word16 nodeIndex);
T_void
IDrawColumn(
    T_word16 x,
    T_word16 top,
...
IDrawRow(
    ...
    T_byte8 color);
T_void
IDrawNode(T_word16 nodeIndex);
T_void
IDrawSSector(T_word16 ssectorIndex);
T_void
IDrawSegment(T_word16 segmentIndex);
T_void
IAddWall(
    T_sword16 sx1,
    T_sword16 sx2,
...
IDrawRuns(T_void);
T_void
IDrawObjectAndWallRuns(T_void);

T_word16
IQuickSquareRoot(T_word32 value);
...
T_void
ISetupDistanceTable(T_void);

T_void
IFindObjects(T_void);
E_Boolean
IFindObject(T_3dObject *p_obj);

T_void
ISortObjects(T_void);
T_void
IDrawObjectColumn(T_word16 column, T_3dObjectColRun *p_objCol);
T_void
IAddObjectSlice(
    T_sword32 zDist,
    T_sword16 x,
...
T_word16
IFindSectorNum(T_sword16 x, T_sword16 y);
T_word32
IDetermineDistToLine(T_sword16 x, T_sword16 y, T_word16 lineNum);
T_byte8
IOnRightOfLine(T_sword16 x, T_sword16 y, T_word16 line);
T_sword32
IFindIntersectX(T_word16 line, T_sword16 y);
T_void
IDrawPixel(T_byte8 *p_pixel, T_byte8 color);

E_Boolean
ICheckValidRow(T_word16 row, T_word16 run);
E_Boolean
ICheckValidRow2(T_word16 row, T_word16 run);

T_sword16
IObjectPartition(T_sword16 p, T_sword16 r);
T_void
ISortObjectQuick(T_sword16 p, T_sword16 q);
 ...
 *<!-----------------------------------------------------------------------*/
T_void
View3dSetHeight(T_sword32 height)
{
    G_3dPlayerHeight = height;
}
 ...
 *<!-----------------------------------------------------------------------*/
T_void
View3dUpdateSectorLightAnimation(T_void)
{
    T_word16 i;
...
T_void
View3dSetUpDownAngle(T_sword32 alpha)
{
...
int
ICompareObjectRuns(const void *first, const void *second)
{
...
T_void
IDrawObjectColumn(T_word16 x, T_3dObjectColRun *p_run)
{
    T_sword32 top, bottom;
...
T_void
View3dSetSize(T_word16 width, T_word16 height)
{
    T_byte8 *p_where;
    T_word16 i;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
View3dClipCenter(T_word16 centerWidth)
{
    T_byte8 *p_where;
    T_word16 i;
    ...
    if (start < end)
    {
            ...
            (row > VIEW3D_HALF_HEIGHT))
        {
            if (sizeY)
            {
                ...
                {
                    case 0:DrawTextureRowAsm1(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 1:DrawTextureRowAsm2(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 2:DrawTextureRowAsm4(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 3:DrawTextureRowAsm8(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 4:DrawTextureRowAsm16(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 5:DrawTextureRowAsm32(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 6:DrawTextureRowAsm64(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 7:DrawTextureRowAsm128(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 8:DrawTextureRowAsm256(p_shade, end - start, x, y, p_pixel);
                        break;
                }
            }
            else
...
*/
            ...
            if (sizeY != 0)
            {
                ...
                switch (MathPower2Lookup(sizeY))
                {
                    case 0:DrawTransRowAsm1(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 1:DrawTransRowAsm2(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 2:DrawTransRowAsm4(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 3:DrawTransRowAsm8(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 4:DrawTransRowAsm16(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 5:DrawTransRowAsm32(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 6:DrawTransRowAsm64(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 7:DrawTransRowAsm128(p_shade, end - start, x, y, p_pixel);
                        break;
                    case 8:DrawTransRowAsm256(p_shade, end - start, x, y, p_pixel);
                        break;
                }
            }
        }
 ...
 *<!-----------------------------------------------------------------------*/
T_void
View3dFreeObject(T_3dObject *p_obj)
{
...
T_void
View3dCheckObjectListEmpty(T_void)
{
 ...
 *<!-----------------------------------------------------------------------*/
T_void
View3dAddObject(T_3dObject *p_obj)
{
 ...
 *<!-----------------------------------------------------------------------*/
T_void
View3dRemoveObject(T_3dObject *p_obj)
{
 ...
 *<!-----------------------------------------------------------------------*/
T_void
View3dSetDarknessAdjustment(T_sbyte8 darkAdjust)
{
...
T_word16
View3dFindClosestLine(T_sword16 x, T_sword16 y)
{
    T_word32 dist;
...
T_word16
View3dGetSectorSide(T_word16 lineNum, T_sword16 x, T_sword16 y)
{
    T_3dLine *p_line;
    T_3dVertex *p_vertex;
    T_sword32 x1;
...
T_word16
View3dGetSide(T_word16 lineNum, T_sword16 x, T_sword16 y)
{
    T_3dLine *p_line;
    T_3dVertex *p_vertex;
    T_sword32 x1;
...
T_word16
View3dFindSide(T_sword16 x, T_sword16 y)
{
    T_word16 line;
    ...
    T_byte8 *p_pixel)
{
    while (count--)
    {
        *(p_pixel++) = p_shade[G_CurrentTexturePos[(((xOffset >> 16) & G_textureAndX) << 1)
            | ((yOffset >> 16) & 0x01)]];
        xOffset += G_textureStepX;
        yOffset += G_textureStepY;
    }
    ...
    T_byte8 *p_pixel)
{
    while (count--)
    {
        *(p_pixel++) = p_shade[G_CurrentTexturePos[(((xOffset >> 16) & G_textureAndX) << 2)
            | ((yOffset >> 16) & 0x03)]];
        xOffset += G_textureStepX;
        yOffset += G_textureStepY;
    }
    ...
    T_byte8 *p_pixel)
{
    while (count--)
    {
        *(p_pixel++) = p_shade[G_CurrentTexturePos[(((xOffset >> 16) & G_textureAndX) << 3)
            | ((yOffset >> 16) & 0x07)]];
        xOffset += G_textureStepX;
        yOffset += G_textureStepY;
    }
    ...
    T_byte8 *p_pixel)
{
    while (count--)
    {
        *(p_pixel++) = p_shade[G_CurrentTexturePos[(((xOffset >> 16) & G_textureAndX) << 4)
            | ((yOffset >> 16) & 0x0F)]];
        xOffset += G_textureStepX;
        yOffset += G_textureStepY;
    }
    ...
    T_byte8 *p_pixel)
{
    while (count--)
    {
        *(p_pixel++) = p_shade[G_CurrentTexturePos[(((xOffset >> 16) & G_textureAndX) << 5)
            | ((yOffset >> 16) & 0x1F)]];
        xOffset += G_textureStepX;
        yOffset += G_textureStepY;
    }
    ...
    T_byte8 *p_pixel)
{
    while (count--)
    {
        *(p_pixel++) = p_shade[G_CurrentTexturePos[(((xOffset >> 16) & G_textureAndX) << 6)
            | ((yOffset >> 16) & 0x3F)]];
        xOffset += G_textureStepX;
        yOffset += G_textureStepY;
    }
    ...
    T_byte8 *p_pixel)
{
    while (count--)
    {
        *(p_pixel++) = p_shade[G_CurrentTexturePos[(((xOffset >> 16) & G_textureAndX) << 7)
            | ((yOffset >> 16) & 0x7F)]];
        xOffset += G_textureStepX;
        yOffset += G_textureStepY;
    }
    ...
    T_byte8 *p_pixel)
{
    while (count--)
    {
        *(p_pixel++) = p_shade[G_CurrentTexturePos[(((xOffset >> 16) & G_textureAndX) << 8)
            | ((yOffset >> 16) & 0xFF)]];
        xOffset += G_textureStepX;
        yOffset += G_textureStepY;
    }
