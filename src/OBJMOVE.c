...
/* Internal prototypes: */
T_void
IObjMoveClipVelocity(T_objMoveStruct *ObjMoveStruct);
T_3dObject *
ObjMoveFindHighestObject(T_objMoveStruct *ObjMoveStruct);
T_3dObject *
ObjMoveFindLowestObject(T_objMoveStruct *ObjMoveStruct);
 ...
 *<!-----------------------------------------------------------------------*/
T_void
ObjMoveUpdate(T_objMoveStruct *ObjMoveStruct, T_sword32 delta)
{
