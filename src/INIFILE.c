...
static T_void
IINIDestroy(T_iniFileStruct *p_ini);
 ...
 *<!-----------------------------------------------------------------------*/
T_iniFile
INIFileOpen(T_byte8 *p_filename)
{
 ...
 *<!-----------------------------------------------------------------------*/
T_void
INIFileClose(T_byte8 *p_filename, T_iniFile iniFile)
{
    T_iniFileStruct *p_ini;
    T_iniCategory *p_cat;
    T_iniKey *p_key;
                    ...
                    for (i = 0; p_found[i] != '\0'; i++)
                    {
                        ...
                        if (isSpecialChar)
                        {
                            switch (p_found[i])
                            {
                                case 't':p_string[len++] = '\t';
                                    break;
                                case 'r':p_string[len++] = '\r';
                                    break;
                                case 'n':p_string[len++] = '\n';
                                    break;
                                default:p_string[len++] = p_found[i];
                                    break;
                            }
