 ...
 *<!-----------------------------------------------------------------------*/
T_void
ColorStoreDefaultPalette(T_void)
{
    T_byte8 p[256][3];
 ...
 *<!-----------------------------------------------------------------------*/
T_void
ColorAddGlobal(T_sword16 red, T_sword16 green, T_sword16 blue)
{
 ...
 *<!-----------------------------------------------------------------------*/
T_void
ColorSetGlobal(T_sbyte8 red, T_sbyte8 green, T_sbyte8 blue)
{
 ...
 *<!-----------------------------------------------------------------------*/
T_void
ColorAddFilt(T_sbyte8 red, T_sbyte8 green, T_sbyte8 blue)
{
    DebugRoutine ("ColorAddGlobal");
 ...
 *<!-----------------------------------------------------------------------*/
T_void
ColorSetFilt(T_sbyte8 red, T_sbyte8 green, T_sbyte8 blue)
{
 ...
 *<!-----------------------------------------------------------------------*/
T_void
ColorSetColor(T_byte8 colornum, T_byte8 red, T_byte8 green, T_byte8 blue)
{
...
T_byte8
ColorGetRed(T_byte8 colornum)
{
    return (G_colorvals[colornum * 3]);
}

T_byte8
ColorGetGreen(T_byte8 colornum)
{
    return (G_colorvals[colornum * 3 + 1]);
}

T_byte8
ColorGetBlue(T_byte8 colornum)
{
...
T_void
ColorFadeTo(T_byte8 red, T_byte8 green, T_byte8 blue)
{
    ...
    for (i = 0; i < 31; i++)
    {
        for (j = 0; j < 768; j += 3)
        {
            for (k = 0; k < 2; k++)
            {
                if (G_colorvals[j] < red)
                    G_colorvals[j]++;
                else if (G_colorvals[j] > red)
                    G_colorvals[j]--;

                if (G_colorvals[j + 1] < green)
                    G_colorvals[j + 1]++;
                else if (G_colorvals[j + 1] > green)
                    G_colorvals[j + 1]--;

                if (G_colorvals[j + 2] < blue)
                    G_colorvals[j + 2]++;
                else if (G_colorvals[j + 2] > blue)
                    G_colorvals[j + 2]--;
            }
        }
        GrSetPalette(0, 256, (T_palette *) &G_colorvals);
