...
static T_void
IUITextDrawChanges(T_UIText uiText);

static T_void
IUITextDrawAll(T_UIText uiText);

static T_void
IUITextAppendCharacter(T_UIText uiText, T_byte8 character);

static T_void
IUITextDrawLine(T_UIText uiText, T_byte8 lineIndex);
...
static T_word16
IUIGetClosestTabPosition(T_UIText uiText, T_word16 offset);

static E_Boolean
IUITextStandardEventHandler(
    T_UIObject object,
    E_UIEvent event,
    T_word16 data1,
    T_word16 data2);
...
static T_void
IUITextSelectArea(T_UIText uiText);

static T_void
IUITextSelectNone(T_UIText uiText);

static T_void
IUITextClipCoordinates(
    T_UIText uiText,
    T_word16 *posX,
    T_word16 *posY);

static T_void
IUITextInsertKeystroke(T_UIText uiText, T_byte8 character);

static T_void
IUITextInsertCharacter(T_UIText uiText, T_byte8 character);

static T_void
IUITextMoveCursorRight(T_UIText uiText);

static T_void
IUITextMoveCursorLeft(T_UIText uiText);

static T_word16
IUITextGetCharacterWidth(
    T_UIText uiText,
    T_word16 offset,
    T_byte8 character);

static T_void
IUITextFormat(T_UIText uiText);

static T_void
IUITextMoveCursorToIndex(
    T_UIText uiText,
...
static T_void
IUITextBackspace(T_UIText uiText);
 ...
 *<!-----------------------------------------------------------------------*/
T_void
UITextDeleteAll(T_UIText uiText)
{
    T_word16 i;
    T_UITextStruct *p_text;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
UITextAppend(T_UIText uiText, T_byte8 *string)
{
 ...
 *<!-----------------------------------------------------------------------*/
T_void
UITextSetTab(T_UIText uiText, T_word16 tabPosition)
{
    T_UITextStruct *p_text;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
UITextScrollDown(T_UIText uiText)
{
    T_UITextStruct *p_text;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
UITextScrollUp(T_UIText uiText)
{
    T_UITextStruct *p_text;
