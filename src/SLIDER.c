...
/* Internal prototypes: */
static T_void
ISliderCallback(T_word32 data);

static T_void
ISliderDestroy(T_slider *p_slider);

static T_slider *
ISliderFind(T_word32 sliderId);
 ...
 *<!-----------------------------------------------------------------------*/
T_void
SliderCancel(T_word32 sliderId)
{
    T_slider *p_slider;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
SliderReverse(T_word32 sliderId, T_word16 newActivity)
{
    T_slider *p_slider;
    T_sword32 temp;
...
T_void
SliderDestroy(T_word32 sliderId)
{
    T_slider *p_slider;
