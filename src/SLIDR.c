...
static T_void
SliderDraw(T_sliderID sliderID);
 ...
 *<!-----------------------------------------------------------------------*/
T_sliderID
SliderCreate(T_word16 lx1, T_word16 ly1, T_word16 lx2)
{
    T_word16 i;
    T_word16 size;
...
T_void
SliderSetCallBack(T_sliderID sliderID, T_sliderHandler sliderhandler)
{
    T_sliderStruct *p_slider;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
SliderDelete(T_sliderID sliderID)
{
    T_word16 i;
    T_sliderStruct *p_slider;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
SliderUpdate(T_sliderID sliderID)
{
    T_sliderStruct *p_slider;
...
SliderUpdateAllSliders(T_void)
{
    ...
    {
        if (G_sliderArray[i] != NULL)
            SliderUpdate(G_sliderArray[i]);
    }
    DebugEnd();
}

T_void
SliderSetValue(T_sliderID sliderID, T_word16 value)
{
    T_sliderStruct *p_slider;
...
T_word16
SliderGetValue(T_sliderID sliderID)
{
    T_sliderStruct *p_slider;
...
E_Boolean
SliderIsAt(T_sliderID sliderID, T_word16 lx, T_word16 ly)
{
    T_sliderStruct *p_slider;
...
T_void
SliderMouseControl(E_mouseEvent event,
                   T_word16 x,
                   T_word16 y,
                   T_buttonClick button)
{
    ...
    switch (event)
    {
        case MOUSE_EVENT_START:selected = NULL;
...
T_void
SliderSetStateBlock(T_void *p_state)
{
