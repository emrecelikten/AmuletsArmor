...
T_void
ComwinInitCommunicatePage(T_void)
{
    ...
    if (sampleset > 0)
        start = G_sampleSetMarkers[sampleset - 1];
    else
        start = 0;
...
T_void
ComwinDisplayCommunicatePage(T_void)
{
    T_TxtboxID TxtboxID;
    T_buttonID buttonID;
...
T_void
ComwinCloseCommunicatePage(T_void)
{
