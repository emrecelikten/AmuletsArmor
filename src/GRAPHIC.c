...
static T_graphicID
GraphicInit(T_word16 lx, T_word16 ly, T_byte8 *bmname);
 ...
 *<!-----------------------------------------------------------------------*/
T_graphicID
GraphicCreate(T_word16 lx, T_word16 ly, T_byte8 *bmname)
{
    T_word16 i;
...
T_void
GraphicSetPreCallBack(T_graphicID graphicID,
...
T_void
GraphicSetPostCallBack(T_graphicID graphicID,
                       T_graphicHandler graphichandler,
                       T_word16 cbinfo)
{
    T_graphicStruct *p_graphic;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
GraphicDelete(T_graphicID graphicID)
{
    T_word16 i;
    T_graphicStruct *p_graphic;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
GraphicUpdate(T_graphicID graphicID)
{
    T_byte8 *p_pic;
    T_bitmap *p_bitmap;
    T_graphicStruct *p_graphic;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
GraphicUpdateAllGraphics(T_void)
{
    T_word16 i;
...
T_void
GraphicUpdateAllGraphicsForced(T_void)
{
    T_word16 i;
    T_graphicStruct *p_graphic;
...
T_void
GraphicUpdateAllGraphicsBuffered(T_void)
{
 ...
 *<!-----------------------------------------------------------------------*/
T_void
GraphicDrawAt(T_graphicID graphicID, T_word16 lx, T_word16 ly)
{
    T_byte8 *p_pic;
    T_bitmap *p_bitmap;
    T_graphicStruct *p_graphic;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
GraphicClear(T_graphicID graphicID, T_byte8 clearcolor)
{
    T_graphicStruct *p_graphic;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
GraphicHide(T_graphicID graphicID)
{
    T_graphicStruct *p_graphic;
...
T_void
GraphicShow(T_graphicID graphicID)
{
    T_graphicStruct *p_graphic;
...
T_void
GraphicSetShadow(T_graphicID graphicID, T_byte8 newshadow)
{
    T_graphicStruct *p_graphic;
...
T_void
GraphicSetOffSet(T_graphicID graphicID, T_word16 x, T_word16 y)
{
    T_graphicStruct *p_graphic;
...
T_void
GraphicSetSize(T_graphicID graphicID, T_word16 sizex, T_word16 sizey)
{
    T_graphicStruct *p_graphic;
...
E_Boolean
GraphicIsVisible(T_graphicID graphicID)
{
    T_graphicStruct *p_graphic;
...
E_Boolean
GraphicIsAt(T_graphicID graphicID, T_word16 lx, T_word16 ly)
{
    T_graphicStruct *p_graphic;
    ...
    if (lx >= p_graphic->locx + p_graphic->xoff - 1 &&
        ...
        ly <= (p_graphic->locy + p_graphic->height + p_graphic->yoff))
        retvalue = TRUE;
...
E_Boolean
GraphicIsShadowed(T_graphicID graphicID)
{
    T_graphicStruct *p_graphic;
    E_Boolean retvalue = FALSE;
...
E_Boolean
GraphicIsOffSet(T_graphicID graphicID)
{
    T_graphicStruct *p_graphic;
    E_Boolean retvalue = FALSE;
    ...
    if (p_graphic->xoff != 0 || p_graphic->yoff != 0)
        retvalue = TRUE;
...
T_void
GraphicDrawToActualScreen(T_void)
{
    G_drawToActualScreen = TRUE;
}

T_void
GraphicDrawToCurrentScreen(T_void)
{
    G_drawToActualScreen = FALSE;
}

T_void
GraphicSetResource(T_graphicID graphicID, T_resource newresource)
{
    T_graphicStruct *p_graphic;
...
T_resource
GraphicGetResource(T_graphicID graphicID)
{
    T_graphicStruct *p_graphic;
    T_resource retvalue;
...
T_void
GraphicSetStateBlock(T_void *p_state)
{
