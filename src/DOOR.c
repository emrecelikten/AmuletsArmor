...
IHandleDoorClosing(
    ...
    E_Boolean isDone);
static T_void
IStartDoorClosing(T_word32 data);
static T_void
IHandleSoundCallback(T_areaSound sound, T_word32 data);
 ...
 *<!-----------------------------------------------------------------------*/
static T_void
IStartDoorClosing(T_word32 sector)
{
 ...
 *<!-----------------------------------------------------------------------*/
E_Boolean
DoorIsAtSector(T_word16 sector)
{
    T_door *p_door;
    E_Boolean isDoor;
 ...
 *<!-----------------------------------------------------------------------*/
T_word16
DoorGetPercentOpen(T_word16 sector)
{
    T_door *p_door;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
DoorDecreaseLock(T_word16 sector, T_word16 amount)
{
    T_door *p_door;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
DoorIncreaseLock(T_word16 sector, T_word16 amount)
{
    T_door *p_door;
 ...
 *<!-----------------------------------------------------------------------*/
T_word16
DoorGetLockValue(T_word16 sector)
{
    T_door *p_door;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
DoorSetRequiredItem(T_word16 doorSector, T_word16 itemType)
{
    T_door *p_door;
 ...
 *<!-----------------------------------------------------------------------*/
T_word16
DoorGetRequiredItem(T_word16 doorSector)
{
    T_word16 itemType = 0;
    T_door *p_door;
