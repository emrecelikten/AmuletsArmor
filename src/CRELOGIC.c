...
/* Internal prototypes: */
static T_creatureLogic *
ICreatureLogicFind(T_word16 objectType);
static T_doubleLinkListElement
ICreatureFindViaObjectPtr(T_3dObject *p_obj);
...
IStepForward(
    ...
    T_3dObject *p_obj);
static E_Boolean
ICreatureTargetLogic(
    T_creatureState *p_creature,
    T_creatureLogic *p_logic,
    T_3dObject *p_obj);

static T_void
CreatureDropTreasure(
    T_creatureState *p_creature,
    T_creatureLogic *p_logic,
    T_3dObject *p_obj);
...
ITargetStandardHitOrShoot(
    ...
    T_3dObject *p_obj);
static E_Boolean
ITargetSuicideExplosion(
    T_creatureState *p_creature,
    T_creatureLogic *p_logic,
    T_3dObject *p_obj);
static E_Boolean
ITargetExplodeOnCollision(
    T_creatureState *p_creature,
    T_creatureLogic *p_logic,
    T_3dObject *p_obj);
static E_Boolean
ITargetScream(
    ...
    T_3dObject *p_obj);
static E_Boolean
ITargetSummonCreature(
    T_creatureState *p_creature,
    T_creatureLogic *p_logic,
    T_3dObject *p_obj);
static E_Boolean
ITargetConstantDamage(
    T_creatureState *p_creature,
    T_creatureLogic *p_logic,
    T_3dObject *p_obj);
...
static T_void
ICreatureDelayedAttack(T_creatureState *p_creature);
...
static T_void
IUpdateTarget(T_creatureState *p_creature);
 ...
 *<!-----------------------------------------------------------------------*/
T_void
CreatureAttachToObject(T_3dObject *p_obj)
{
    T_creatureState *p_creature;
    T_creatureLogic *p_logic;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
CreatureDetachFromObject(T_3dObject *p_obj)
{
                ...
                if (p_obj->inWorld == TRUE)
                {
                    ...
                    if (p_logic->wanderSound != 0)
                    {
                        ...
                        if (!CreatureIsMissile(p_obj))
                        {
                            ...
                            {
                                p_creature->lastWanderSound =
                                    SyncTimeGet() + 700 + (RandomValue() % 700);
...
//                stepSize = p_logic->stepSize ;
                ...
                if (p_creature->targetDistance == 0)
                    ...
                    dz = (((T_sword32) stepSize)
                        * ((T_sword32) (((T_sword32) targetHeight) - ((T_sword32) z))))
                        / ((T_sword32) p_creature->targetDistance);
        ...
        if (num == 0)
        {
            ...
            if (p_logic->minMissileRange == 0)
            {
                if (rand() % 6 == 0)
                    ...
                    ICreatureMakeSound(p_obj, p_logic->attackSound2);
            }
            else
                ICreatureMakeSound(p_obj, p_logic->attackSound2);
        }
                ...
                (p_logic->canHurtSelf == TRUE))
            {
                ...
                if (type & EFFECT_DAMAGE_SPECIAL)
                {
                    switch (type & (~EFFECT_DAMAGE_SPECIAL))
                    {
                        ...
                        case EFFECT_DAMAGE_SPECIAL_PUSH:break;
                        case EFFECT_DAMAGE_SPECIAL_PULL:break;
                        ...
                        case EFFECT_DAMAGE_SPECIAL_EARTHBIND:
                            ...
                            break;
                        case EFFECT_DAMAGE_SPECIAL_CONFUSE:ObjectSetAngle(p_creature->p_obj, (RandomValue() << 2));
...
#else
T_word16
CreatureLookForPlayer(T_3dObject *p_obj)
{
...
T_void
CreaturePlayerGone(T_player player)
{
}
...
E_Boolean
CreatureIsMissile(T_3dObject *p_obj)
{
    T_creatureState *p_creature;
    T_creatureLogic *p_logic;
    ...
    T_3dObject *p_obj)
{
    ...
    if (p_creature->wasStolenFrom == FALSE)
    {
        ...
        {
            case TREASURE_TYPE_NONE:break;
            case TREASURE_TYPE_1_PLAT:ServerCreateObjectGlobal(106, x, y, z);
                break;
            case TREASURE_TYPE_1_GOLD:ServerCreateObjectGlobal(104, x, y, z);
                break;
            case TREASURE_TYPE_1_SILVER:ServerCreateObjectGlobal(102, x, y, z);
                break;
            case TREASURE_TYPE_5_COPPER:ServerCreateObjectGlobal(101, x, y, z);
                break;
            case TREASURE_TYPE_SHADOW:break;
            case TREASURE_TYPE_LICH:break;
            case TREASURE_TYPE_ELK:ServerCreateObjectGlobal(247, x, y - 2, z);  /* Piece of meat */
...
//                ObjectSetAccData(p_newobj, 410) ;
                break;
            case TREASURE_TYPE_BAD_KNIGHT:ServerCreateObjectGlobal(badKnightList[r % 12], x, y, z);
                break;
            case TREASURE_TYPE_MITHRIL_BAD_KNIGHT:ServerCreateObjectGlobal(mithrilBadKnightList[r % 12], x, y, z);
                break;
            ...
            case TREASURE_TYPE_POISON_DRUID:
                ...
                break;
            case TREASURE_TYPE_EVIL_KNIGHT:ServerCreateObjectGlobal(evilKnightList[r % 12], x, y, z);
                break;
            case TREASURE_TYPE_SILVER_EVIL_KNIGHT:ServerCreateObjectGlobal(silverEvilKnightList[r % 12], x, y, z);
                break;
...
//                ServerCreateObjectGlobal(260, x, y, z) ;
            ...
            case TREASURE_TYPE_KOA_HORSEMAN:
                ...
                ObjectSetAccData(p_newobj, 6);
                break;
            case TREASURE_TYPE_BRONZE_EVIL_KNIGHT:ServerCreateObjectGlobal(bronzeEvilKnightList[r % 12], x, y, z);
                break;
            case TREASURE_TYPE_TROJAN:ServerCreateObjectGlobal(trojanList[r % 12], x, y, z);
                break;
            default:break;
        }
    }
...
T_word16
CreatureStolenFrom(T_3dObject *p_obj)
{
    ...
    if (element != DOUBLE_LINK_LIST_ELEMENT_BAD)
    {
        ...
        if (p_creature->wasStolenFrom == FALSE)
        {
            ...
            {
                case TREASURE_TYPE_NONE:break;
                case TREASURE_TYPE_1_PLAT:item = 106;
                    break;
                case TREASURE_TYPE_1_GOLD:item = 104;
                    break;
                case TREASURE_TYPE_1_SILVER:item = 102;
                    break;
                case TREASURE_TYPE_5_COPPER:item = 101;
                    break;
                case TREASURE_TYPE_SHADOW:break;
                case TREASURE_TYPE_LICH:break;
                case TREASURE_TYPE_ELK:break;
                case TREASURE_TYPE_ELF_ARCHER:item = 100;    /* copper coin */
                    break;
                case TREASURE_TYPE_EXIGUUS: /* Cemetary wizard */
                    item = 416;    /* ring */
                    break;
                case TREASURE_TYPE_BAD_KNIGHT:item = 818;    /* strength potion */
                    break;
                case TREASURE_TYPE_MITHRIL_BAD_KNIGHT:item = 32968;  /* Mithril dagger */
                    break;
                case TREASURE_TYPE_EVIL_ORANGE_WIZARD:item = 104;  /* gold piece */
                    break;
                case TREASURE_TYPE_BLUE_WIZARD:
                    if (r & 1)
                ...
                case TREASURE_TYPE_POISON_DRUID:
                    ...
                    break;
                case TREASURE_TYPE_EVIL_KNIGHT:item = 102;  /* Silver coin */
                    break;
                case TREASURE_TYPE_SILVER_EVIL_KNIGHT:item = 103;  /* 5 silver coin */
                    break;
                case TREASURE_TYPE_VITORIX:item = 234;  /* Electric mace */
                    break;
                case TREASURE_TYPE_JUGURTHA:
                    /* Ring of armor 1 */
                    item = 415;
...
//                    item = 260 ;
                    break;
                case TREASURE_TYPE_KOA_FOOTMAN:break;
                case TREASURE_TYPE_KOA_HORSEMAN:break;
                case TREASURE_TYPE_BRONZE_EVIL_KNIGHT:item = 202;
                    break;
                case TREASURE_TYPE_TROJAN:item = 202;
                    break;
                default:break;
            }
...
T_void
CreatureSetTarget(T_3dObject *p_obj, T_word16 targetID)
{
    T_3dObject *p_target;
    T_creatureState *p_creature;
    T_doubleLinkListElement element;
...
/* LES 09/10/96 */
T_void
CreaturesHearSoundOfPlayer(T_3dObject *p_player, T_word16 distance)
{
    T_doubleLinkListElement element;
    T_doubleLinkListElement nextElement;
    T_creatureState *p_creature;
...
T_void
CreaturesAllOnOneTarget(T_word16 targetId)
{
    T_doubleLinkListElement element;
    T_doubleLinkListElement nextElement;
    T_creatureState *p_creature;
