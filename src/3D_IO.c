...
IDumpData(T_void);
static T_void
IPrepareObjects(T_void);
static T_void
ILoadBlockMap(
    T_file file,
    T_directoryEntry *p_dir);
static T_void
ILockPictures(T_void);
static T_void
IUnlockPictures(T_void);
static T_void
ILoadSectorInfo(T_byte8 *mapName);
...
static T_void
IOutputReject(T_void);

static T_void
IObjCollisionListsInit(T_void);
static T_void
IObjCollisionListsFinish(T_void);
...
//printf ("Copying sector info from %d to %d\n", sector, sector2);
        ...
        else
        {
            ...
            switch (submode)
            {
                case 0:G_3dSectorInfoArray[sector].textureXOffset = var;
                    break;
                case 1:G_3dSectorInfoArray[sector].textureYOffset = var;
                    break;
                case 2:G_3dSectorInfoArray[sector].xVelAdd = var;
                    break;
                case 3:G_3dSectorInfoArray[sector].yVelAdd = var;
                    break;
                case 4:G_3dSectorInfoArray[sector].zVelAdd = var;
                    break;
                case 5:G_3dSectorInfoArray[sector].gravity = var;
                    break;
                case 6:G_3dSectorInfoArray[sector].friction = var;
                    break;
                case 7:G_3dSectorInfoArray[sector].damage = var;
                    break;
                case 8:G_3dSectorInfoArray[sector].depth = var;
                    break;
                case 9:G_3dSectorInfoArray[sector].enterSound = var;
                    break;
                case 10:G_3dSectorInfoArray[sector].enterSoundRadius = var;
                    break;
                case 11:G_3dSectorInfoArray[sector].lightAnimationType = var;
                    G_3dSectorInfoArray[sector].lightAnimationState = 0;
                    break;
                case 12:G_3dSectorInfoArray[sector].lightAnimationRate = var;
                    break;
                case 13:G_3dSectorInfoArray[sector].lightAnimationCenter = var;
                    break;
                case 14:G_3dSectorInfoArray[sector].lightAnimationRadius = var;
...
T_void
View3dSetSectorType(T_word16 sector, T_word16 sectorType)
{
...
T_void
IAssignWallAt(T_sword16 x, T_sword16 y, T_word16 animNum)
{
    T_word16 side;
...
T_void
View3dResolveSpecialObjects(T_void)
{
    ...
    while (element != DOUBLE_LINK_LIST_ELEMENT_BAD)
    {
        ...
        {
            case SPECIAL_OBJECT_DOOR:sector = View3dFindSectorNum(x, y);
            ...
            case SPECIAL_OBJECT_GENERATOR:
                GeneratorAddGenerator(
                    ...
                    0);
                break;
            case SPECIAL_OBJECT_DIRT_SECTOR:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    View3dSetSectorType(
                        sector,
                        SECTOR_TYPE_DIRT);
                break;
            case SPECIAL_OBJECT_ICE_SECTOR:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    View3dSetSectorType(
                        sector,
                        SECTOR_TYPE_ICE);
                break;
            case SPECIAL_OBJECT_WATER_SECTOR:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    View3dSetSectorType(
                        sector,
                        SECTOR_TYPE_WATER);
                break;
            case SPECIAL_OBJECT_LAVA_SECTOR:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    View3dSetSectorType(
                        sector,
                        SECTOR_TYPE_LAVA);
                break;
            case SPECIAL_OBJECT_MUD_SECTOR:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    View3dSetSectorType(
                        sector,
                        SECTOR_TYPE_MUD);
                break;
            case SPECIAL_OBJECT_ACID_SECTOR:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    View3dSetSectorType(
                        sector,
            ...
            case SPECIAL_OBJECT_AREA_SOUND_ELECTRICITY:
                ...
                AreaSoundSetGroupId(areaSound, p_object->attributes);
                break;
            case SPECIAL_OBJECT_LEVEL_LINK:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    G_3dSectorInfoArray[sector].nextMap =
                        p_object->attributes;
                break;
            case SPECIAL_OBJECT_LEVEL_LINK_PLACE:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    G_3dSectorInfoArray[sector].nextMapStart =
                        p_object->attributes;
                break;
            case SPECIAL_OBJECT_GLASS_CEILING:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    G_3dSectorInfoArray[sector].ceilingLimit =
                        MapGetFloorHeight(sector) + p_object->attributes;
                break;
            case SPECIAL_OBJECT_DEPTH:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                {
                ...
                break;
            case SPECIAL_OBJECT_SECTOR_ANIMATION:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    MapSetSectorState(sector, p_object->attributes);
                break;
            case SPECIAL_OBJECT_FLOW_SLOW:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    MapSetSectorState(sector, p_object->angle);
                break;
            case SPECIAL_OBJECT_FLOW_MEDIUM:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    MapSetSectorState(sector, 8 + p_object->angle);
                break;
            case SPECIAL_OBJECT_FLOW_FAST:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                    MapSetSectorState(sector, 16 + p_object->angle);
                break;
            case SPECIAL_OBJECT_GLOW:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                {
            ...
            case SPECIAL_OBJECT_AREA_SOUND_WATER_DRIP:
                ...
                AreaSoundSetGroupId(areaSound, p_object->attributes);
                break;
            case SPECIAL_OBJECT_FLOW_WALL_UP1:IAssignWallAt(x, y, 0);
                break;
            case SPECIAL_OBJECT_FLOW_WALL_UP2:IAssignWallAt(x, y, 1);
                break;
            case SPECIAL_OBJECT_FLOW_WALL_UP3:IAssignWallAt(x, y, 2);
                break;
            case SPECIAL_OBJECT_FLOW_WALL_DOWN1:IAssignWallAt(x, y, 3);
                break;
            case SPECIAL_OBJECT_FLOW_WALL_DOWN2:IAssignWallAt(x, y, 4);
                break;
            case SPECIAL_OBJECT_FLOW_WALL_DOWN3:IAssignWallAt(x, y, 5);
                break;
        }
    ...
    while (element != DOUBLE_LINK_LIST_ELEMENT_BAD)
    {
        ...
        switch (p_object->objectType)
        {
            case SPECIAL_OBJECT_LOCK_DOOR:sector = View3dFindSectorNum(x, y);
                DebugCheck(sector != 0xFFFF);
                if (sector != 0xFFFF)
                {
                    if (DoorIsAtSector(sector))
...
T_sword16
View3dCalculateLowestCeiling(T_word16 sector)
{
    T_word16 i;
    T_3dLine *p_line;
    T_3dSide *p_side1;
...
/* LES 06/03/96 Created */
T_void
View3dDestroyMapGroup(T_mapGroup p_mapGroup)
{
...
/* LES 06/03/96 Created */
T_void
View3dSetMapGroup(T_mapGroup p_mapGroup)
{
...
/* LES 06/03/96 Created */
T_void
View3dGetMapGroup(T_mapGroup p_mapGroup)
{
    T_mapGroupStruct *p_map;
