...
/* Internal prototypes: */
T_void
ICmdQDiscardPacket(T_byte8 commandNum, T_cmdQPacketStruct *p_packet);
 ...
 *<!-----------------------------------------------------------------------*/
T_void
CmdQRegisterClientCallbacks(T_cmdQActionRoutine *callbacks)
{
    T_word16 i;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
CmdQForcedReceive(T_packetEitherShortOrLong *p_packet)
{
    T_word16 command;
