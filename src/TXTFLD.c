 ...
 *<!-----------------------------------------------------------------------*/
T_void
TxtfldDelete(T_TxtfldID TxtfldID)
{
    T_word16 i;
    T_TxtfldStruct *p_Txtfld;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
TxtfldSetColor(T_TxtfldID TxtfldID, T_byte8 fc, T_byte8 bc)
{
    T_TxtfldStruct *p_Txtfld;
...
T_void
TxtfldSetData(T_TxtfldID txtfldID, T_byte8 *newdata)
{
    T_TxtfldStruct *p_txtfld;
    T_word16 i;
...
T_byte8 *
TxtfldGetData(T_TxtfldID txtfldID)
{
    T_TxtfldStruct *p_txtfld;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
TxtfldCursLeft(T_TxtfldID TxtfldID)
{
    T_TxtfldStruct *p_Txtfld;
    ...
    p_Txtfld = (T_TxtfldStruct *) TxtfldID;
    p_Txtfld->cursorx--;
    if (p_Txtfld->cursorx > MAX_TXTFLD_WIDTH)
        p_Txtfld->cursorx = 0;
...
T_void
TxtfldCursRight(T_TxtfldID TxtfldID)
{
    T_TxtfldStruct *p_Txtfld;
    ...
    {
        if (p_Txtfld->data[p_Txtfld->cursorx - 1] == '\0')
            p_Txtfld->cursorx--;
    }
 ...
 *<!-----------------------------------------------------------------------*/
T_void
TxtfldBackSpace(T_TxtfldID TxtfldID)
{
    T_word16 i, j;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
TxtfldTextDrawCallBack(T_graphicID graphicID, T_word16 index)
{
    T_graphicStruct *p_graphic;
    T_TxtfldStruct *p_Txtfld;
    T_bitfont *p_font;
...
T_graphicID
TxtfldGetTextGraphicID(T_TxtfldID TxtfldID)
{
...
T_TxtfldID
TxtfldIsAt(T_word16 lx, T_word16 ly)
{
    T_word16 i;
    T_TxtfldStruct *p_Txtfld;
    T_graphicStruct *p_graphic;
...
T_byte8 *
TxtfldGetLine(T_TxtfldID TxtfldID)
{
    T_TxtfldStruct *p_Txtfld;
...
E_Boolean
TxtfldUseKey(T_TxtfldID TxtfldID, T_byte8 key)
{
    T_TxtfldStruct *p_Txtfld;
    T_graphicStruct *p_graphic;
...
//	fflush (stdout);
    ...
    else if (key == 13)
    {
        ...
        if (p_Txtfld->retfunction != NULL)
            p_Txtfld->retfunction(TxtfldID);
    }
    else if (key == 9)
    {
        /* tab was hit, call the tabfunction if available */
        if (p_Txtfld->tabfunction != NULL)
            p_Txtfld->tabfunction(TxtfldID);
    }
...
T_void
TxtfldRedraw(T_TxtfldID TxtfldID)
{
    T_graphicStruct *p_graphic;
    T_TxtfldStruct *p_Txtfld;
...
TxtfldNextField(T_void)
{
    ...
    G_currentTxtFld += 1;
    if (G_currentTxtFld >= MAX_TXTFLDS)
        G_currentTxtFld = 0;
...
T_void
TxtfldKeyControl(E_keyboardEvent event, T_byte8 scankey)
{
    T_TxtfldStruct *p_txtfld;
    ...
    switch (event)
    {
        case KEYBOARD_EVENT_BUFFERED: TxtfldUseKey(G_TxtfldArray[G_currentTxtFld], scankey);
            break;

        case KEYBOARD_EVENT_PRESS:
            if (scankey == KEY_SCAN_CODE_LEFT)
                TxtfldCursLeft(G_TxtfldArray[G_currentTxtFld]);
            if (scankey == KEY_SCAN_CODE_RIGHT)
                TxtfldCursRight(G_TxtfldArray[G_currentTxtFld]);
            if (scankey == KEY_SCAN_CODE_BACKSPACE)
                TxtfldBackSpace(G_TxtfldArray[G_currentTxtFld]);
            if (scankey == KEY_SCAN_CODE_DELETE)
                TxtfldDel(G_TxtfldArray[G_currentTxtFld]);
        default: break;
    }
...
T_void
TxtfldMouseControl(E_mouseEvent event,
                   T_word16 x,
                   T_word16 y,
                   E_Boolean button)
{
