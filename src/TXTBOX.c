...
static T_void
TxtboxAppendKeyNoRepag(T_TxtboxID TxtboxID, T_byte8 scankey);
 ...
 *<!-----------------------------------------------------------------------*/
T_void
TxtboxDelete(T_TxtboxID TxtboxID)
{
    T_word16 i;
    T_TxtboxStruct *p_Txtbox;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
TxtboxCursTop(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxCursBot(T_TxtboxID TxtboxID)
{
    T_word16 wrow;
    T_TxtboxStruct *p_Txtbox;
    ...
    switch (p_Txtbox->mode)
    {
        ...
        case Txtbox_MODE_FIXED_WIDTH_FIELD:
            ...
            if (wrow >= p_Txtbox->windowrows)
                wrow -= p_Txtbox->windowrows;
...
T_void
TxtboxCursHome(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxCursEnd(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxCursUp(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
    ...
    else
    {
        switch (p_Txtbox->mode)
        {
            case Txtbox_MODE_EDIT_FIELD:
            case Txtbox_MODE_EDIT_FORM:
            case Txtbox_MODE_FIXED_WIDTH_FIELD:p_Txtbox->cursorl = TxtboxScanRow(TxtboxID, -1, p_Txtbox->cursorx);
                p_Txtbox->cursorline--;
                break;

            case Txtbox_MODE_VIEW_SCROLL_FORM:
            case Txtbox_MODE_SELECTION_BOX:p_Txtbox->cursorline--;
...
T_void
TxtboxCursDn(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxCursLeft(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxCursRight(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxCursPgUp(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxCursPgDn(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxCursSetRow(T_TxtboxID TxtboxID, T_word16 row)
{
    T_TxtboxStruct *p_Txtbox;
    ...
    p_Txtbox = (T_TxtboxStruct *) TxtboxID;
    if (row > p_Txtbox->totalrows)
        row = p_Txtbox->totalrows;
...
T_word32
TxtboxScanRow(T_TxtboxID TxtboxID, T_word16 rowinc, T_word16 ox)
{
    T_TxtboxStruct *p_Txtbox;
    T_bitfont *p_font;
    ...
    if (startrow > p_Txtbox->totalrows)
        startrow = p_Txtbox->totalrows;
    ...
    if (retvalue >= strlen(p_Txtbox->data))
        retvalue = strlen(p_Txtbox->data);


    /* check for total failure */
    if (retvalue == 0 && startx < targetx)
        retvalue = strlen(p_Txtbox->data);
...
T_void
TxtboxAppendKey(T_TxtboxID TxtboxID, T_word16 scankey)
{
    T_TxtboxStruct *p_Txtbox;
    T_byte8 *newdata;
    T_word32 len;
...
T_void
TxtboxBackSpace(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
    T_byte8 *newdata;
    T_word32 len;
...
T_void
TxtboxAppendString(T_TxtboxID TxtboxID, T_byte8 *data)
{
    T_byte8 val;
    T_word16 i;
...
//tempstr2[j++]=val+128;
            ...
            TxtboxAppendKeyNoRepag(TxtboxID, data[i]);
...
T_void
TxtboxSetData(T_TxtboxID TxtboxID, T_byte8 *string)
{
    T_TxtboxStruct *p_Txtbox;
    T_word16 i, cnt = 0;
    T_byte8 val;
...
T_void
TxtboxSetNData(T_TxtboxID TxtboxID, T_byte8 *string, T_word32 len)
{
    T_TxtboxStruct *p_Txtbox;
    T_word16 i, cnt = 0;
    T_byte8 val;
...
T_byte8 *
TxtboxGetData(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_word32
TxtboxGetDataLength(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxSetColor(T_TxtboxID TxtboxID,
               T_byte8 txtcolor,
               T_byte8 bkcolor,
               T_byte8 txtshadow,
               T_byte8 bordclr1,
...
E_Boolean
TxtboxIsAt(T_TxtboxID TxtboxID, T_word16 x, T_word16 y)
{
    T_TxtboxStruct *p_Txtbox;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
TxtboxKeyControl(E_keyboardEvent event, T_word16 scankey)
{
        ...
        case KEYBOARD_EVENT_BUFFERED:
            ...
            else if (scankey == 13)
            {
                ...
                switch (p_Txtbox->mode)
                {
                    ...
                    case Txtbox_MODE_EDIT_FIELD:
                    case Txtbox_MODE_FIXED_WIDTH_FIELD:
                    case Txtbox_MODE_VIEW_SCROLL_FORM:G_currentAction = Txtbox_ACTION_ACCEPTED;
...
//                TxtboxNextBox();
                    ...
                    case Txtbox_MODE_EDIT_FORM:TxtboxAppendKey(G_TxtboxArray[G_currentTextBox], scankey);
                        G_currentAction = Txtbox_ACTION_DATA_CHANGED;
                    default:break;
                }
            }
...
T_void
TxtboxMouseControl(E_mouseEvent event, T_word16 x, T_word16 y, T_buttonClick button)
{
    ...
    switch (event)
    {
        case MOUSE_EVENT_START:selectedsb = NULL;
            selected = NULL;
                ...
                if (G_TxtboxArray[i] != NULL)
                {
                    ...
                    if (p_Txtbox->sbgrID != NULL)
                    {
                        if (GraphicIsAt(p_Txtbox->sbgrID, x, y))
                        {
                            ...
                            G_currentAction = Txtbox_ACTION_SELECTION_CHANGED;
                            if (p_Txtbox->Txtboxcallback != NULL)
                                p_Txtbox->Txtboxcallback(G_TxtboxArray[i]);
                        }
                    }
                    ...
                    if (TxtboxIsAt(G_TxtboxArray[i], x, y))
                    {
                            ...
                            p_Txtbox->mode > Txtbox_MODE_VIEW_NOSCROLL_FORM)
                        {
                            ...
                            if (p_Txtbox2->Txtboxcallback != NULL)
                                p_Txtbox2->Txtboxcallback(G_TxtboxArray[G_currentTextBox]);
                            ...
                            switch (p_Txtbox->mode)
                            {
                                ...
                                case Txtbox_MODE_SELECTION_BOX:G_currentAction = Txtbox_ACTION_SELECTION_CHANGED;
        ...
        case MOUSE_EVENT_HELD:
            if (selected != NULL)
            {
                ...
                switch (p_Txtbox->mode)
                {
                    case Txtbox_MODE_EDIT_FORM:
                    case Txtbox_MODE_EDIT_FIELD:
                    case Txtbox_MODE_FIXED_WIDTH_FIELD:break;
                    ...
                    case Txtbox_MODE_SELECTION_BOX:
                        ...
                        if (y < p_Txtbox->ly1)
                        {
                            ...
                            else
                            {
                                p_Txtbox->cursorline = 0;
                                p_Txtbox->cursorl = 0;
                                if (p_Txtbox->windowstartline > 0)
                                    p_Txtbox->windowstartline--;
                            }
                        }
                        else if (y > p_Txtbox->ly2)
                        {
                            if (p_Txtbox->cursorline
                                < p_Txtbox->windowstartline + p_Txtbox->windowrows + 1)
                            {
                                p_Txtbox->cursorline =
                                    p_Txtbox->windowstartline + p_Txtbox->windowrows + 1;
                                if (p_Txtbox->cursorline > p_Txtbox->totalrows)
                        ...
                        G_currentAction = Txtbox_ACTION_SELECTION_CHANGED;
                        if (p_Txtbox->Txtboxcallback != NULL)
                            p_Txtbox->Txtboxcallback(selected);
                        break;
            ...
            if (selectedsb != NULL)
            {
                if (!TxtboxValidateID(selectedsb))
                    selectedsb = NULL;
                else
...
TxtboxNextBox(T_void)
{
    ...
    G_currentTextBox++;
    if (G_currentTextBox >= MAX_TxtboxES)
        G_currentTextBox = 0;
    ...
    while (G_TxtboxArray[G_currentTextBox] == NULL)
    {
        ...
        if (G_currentTextBox >= MAX_TxtboxES)
            G_currentTextBox = 0;
        if (G_currentTextBox == oldTxtbox)
            break; /* we looped around */
    }
 ...
 *<!-----------------------------------------------------------------------*/
T_void
TxtboxUpdate(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
    T_graphicStruct *p_graphic;
...
T_void
TxtboxDrawCallBack(T_graphicID graphicID, T_word16 index)
{
    T_word32 i, j, k;
    T_word16 wsize;
...
//    GraphicDrawToCurrentScreen();
    ...
    if (endline > p_Txtbox->totalrows)
        endline = p_Txtbox->totalrows;
...
//    bcolor2=p_Txtbox->textshadow;
    ...
    for (i = startline; i <= endline; i++)
    {
        ...
        if (i + 1 > p_Txtbox->totalrows)
            loopend = strlen(p_Txtbox->data);
        else
            loopend = p_Txtbox->linestarts[i + 1];
...
//        }
        ...
        for (j = loopstart; j < loopend; j++)
        {
            ...
            if (curposy + p_Txtbox->fontheight > p_Txtbox->ly2)
                break;
            ...
            else if (p_Txtbox->data[j] > 31 && p_Txtbox->data[j] < 128)
            {
                ...
                if (j == p_Txtbox->cursorl && p_Txtbox->isselected == TRUE
                    && (p_Txtbox->mode <= Txtbox_MODE_EDIT_FORM ||
                        p_Txtbox->mode
                ...
                else
                {
                    ...
                    else if (p_Txtbox->isselected == TRUE)
                    {
                        ...
                        GrDrawShadowedText(tempstr, p_Txtbox->textcolor, p_Txtbox->textshadow);
                }
...
T_void
TxtboxRepaginateAll(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
    T_word16 templn;
...
T_void
TxtboxRepaginate(T_TxtboxID TxtboxID)
{
    T_word16 i, j;
    T_word16 wsize;
    T_word16 linecnt;
    ...
    for (i = p_Txtbox->linestarts[p_Txtbox->cursorline]; i <= strlen(p_Txtbox->data); i++)
    {
        ...
        if (p_Txtbox->data[i] == 13)
        {
            ...
            curposx = p_Txtbox->lx1;
            if (linecnt >= p_Txtbox->totalrows)
                TxtboxAllocLine(TxtboxID);
        ...
        {   /* normal character */
            ...
            if (curposx + wsize > p_Txtbox->lx2)
            {
                /* reached end of line, traverse backwards until we
                     find a space */
                if (linecnt > 0)
                    end = p_Txtbox->linestarts[linecnt - 1];
                else
                    end = 0;
...
T_void
TxtboxSetScrollBarObjIDs(T_TxtboxID TxtboxID,
                         T_buttonID sbupID,
                         T_buttonID sbdnID,
                         T_graphicID sbgrID)
{
...
T_void
TxtboxHandleSBDn(T_buttonID buttonID)
{
    T_TxtboxID TxtboxID;
...
T_void
TxtboxHandleSBUp(T_buttonID buttonID)
{
    T_TxtboxID TxtboxID;
    T_buttonStruct *p_button;
...
T_void
TxtboxUpdateSB(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
    T_graphicStruct *p_graphic;
...
//    GraphicDrawToCurrentScreen();
    ...
    else
    {
        ...
        {
            ratio =
                ((float) p_Txtbox->windowstartline) / ((float) p_Txtbox->totalrows + 1 - p_Txtbox->windowrows);
...
T_void
TxtboxMoveSB(T_TxtboxID TxtboxID, T_word16 y)
{
    T_TxtboxStruct *p_Txtbox;
    T_graphicStruct *p_graphic;
    T_word16 center;
    ...
    if (y < p_Txtbox->sbstart)
        TxtboxCursPgUp(TxtboxID);
    else if (y > p_Txtbox->sbstart + p_Txtbox->sblength)
        TxtboxCursPgDn(TxtboxID);
    else
    {
        ...
        G_currentAction = Txtbox_ACTION_SELECTION_CHANGED;
        if (p_Txtbox->Txtboxcallback != NULL)
            p_Txtbox->Txtboxcallback(TxtboxID);
...
T_void
TxtboxAllocLine(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxSetCallback(T_TxtboxID TxtboxID, T_TxtboxHandler newcallback)
{
    T_TxtboxStruct *p_Txtbox;
...
T_void
TxtboxSetNumericOnlyFlag(T_TxtboxID TxtboxID, E_Boolean newflag)
{
    T_TxtboxStruct *p_Txtbox;
...
E_TxtboxAction
TxtboxGetAction(T_void)
{
    return (G_currentAction);
}

E_Boolean
TxtboxValidateID(T_TxtboxID TxtboxID)
{
    T_word16 i;
    E_Boolean retvalue = FALSE;
...
T_word16
TxtboxGetSelectionNumber(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
    T_word16 retvalue;
...
E_Boolean
TxtboxIsSelected(T_TxtboxID TxtboxID)
{
    T_TxtboxStruct *p_Txtbox;
    E_Boolean retvalue;
...
T_void
TxtboxSetMaxLength(T_TxtboxID TxtboxID, T_word32 newmaxlen)
{
    T_TxtboxStruct *p_Txtbox;
...
T_word16
TxtboxCanFit(T_TxtboxID TxtboxID, T_byte8 *stringToFit)
{
    T_word16 widthcnt = 0;
    T_word16 boxwidth = 0;
    T_word16 charcnt = 0;
...
T_void
TxtboxSetStateBlock(T_void *p_state)
{
