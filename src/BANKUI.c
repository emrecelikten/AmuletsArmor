...
static T_void
BankUIDeposit(T_buttonID buttonID);
static T_void
BankUIReorderSavedCoins();
static T_void
BankUIWithdraw(T_buttonID buttonID);
static T_void
BankUIUpdateGraphics(T_void);
...
BankUIStart(T_word32 formNum)
{
    ...
    /* load backdrop */
    G_backgroundPic = GraphicCreate(4, 3, (T_byte8 *) "UI/BANK/BANKBACK");
