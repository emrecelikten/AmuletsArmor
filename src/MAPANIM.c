...
static T_void
IMapAnimDoInitStates(T_mapAnimHeaderStruct *p_mapAnimHeader);
 ...
 *<!-----------------------------------------------------------------------*/
T_mapAnimation
MapAnimateLoad(T_word32 number)
{
    T_byte8 name[40];
    T_mapAnimHeaderStruct *p_mapAnimHeader;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
MapAnimateUnload(T_mapAnimation mapAnimation)
{
    T_mapAnimHeaderStruct *p_mapAnimHeader;
 ...
 *<!-----------------------------------------------------------------------*/
T_void
MapAnimateUpdate(T_mapAnimation mapAnimation)
{
    T_mapAnimHeaderStruct *p_mapAnimHeader;
    T_word32 delta;
    T_word32 time;
