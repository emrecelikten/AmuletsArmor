...
*
****************************************************************************/
BOOL cdeclhmiINIOpen(_INI_INSTANCE *sInstance, PSTR szName)
{
    W32 hFile;
    ...
    if ((sInstance->pData = (PSTR)
        malloc(sInstance->wMaxSize)) == _NULL )
    {
        // close file
        close(hFile);
...
*
****************************************************************************/
BOOL cdeclhmiINIClose(_INI_INSTANCE *sInstance)
{
    W32 hFile;
...
*
****************************************************************************/
BOOL cdeclhmiINILocateSection(_INI_INSTANCE *sInstance, PSTR szName)
{
    PSTR pDataPtr;
    PSTR pSectionPtr;
    PSTR szSection;
...
*
****************************************************************************/
BOOL cdeclhmiINILocateItem(_INI_INSTANCE *sInstance, PSTR szItem)
{
    PSTR pDataPtr;
    PSTR pItemPtr;
    PSTR szSearch;
...
*
****************************************************************************/
BOOL cdeclhmiINIGetDecimal(_INI_INSTANCE *sInstance, W32 *wValue)
{
    PSTR pDataPtr;
    W32 wDValue;
    BYTE bBuffer[32];
...
*
****************************************************************************/
BOOL cdeclhmiINIGetString(_INI_INSTANCE *sInstance, PSTR pString, W32 wMaxLength)
{
    PSTR pDataPtr;
    W32 wIndex;
...
*
****************************************************************************/
BOOL cdeclhmiINIGetRawString(_INI_INSTANCE *sInstance, PSTR pString, W32 wMaxLength)
{
    PSTR pDataPtr;
    PSTR pEOFPtr;
    W32 wIndex;
...
*
****************************************************************************/
BOOL cdeclhmiINIWriteDecimal(_INI_INSTANCE *sInstance, W32 wValue)
{
    PSTR pDataPtr;
    PSTR pValuePtr;
    BYTE bBuffer[32];
...
*
****************************************************************************/
BOOL cdeclhmiINIWriteString(_INI_INSTANCE *sInstance, PSTR szString)
{
    PSTR pDataPtr;
    PSTR pStringPtr;
    W32 wMoveSize;
...
*
****************************************************************************/
BOOL cdeclhmiINIGetQuery(_INI_INSTANCE *sInstance, PSTR szItem)
{
    BYTE bBuffer[32];
...
*
****************************************************************************/
BOOL cdeclhmiINIGetItemDecimal(_INI_INSTANCE *sInstance, PSTR szItem,
                               W32 *wValue)
{
...
*
****************************************************************************/
BOOL cdeclhmiINIGetItemString(_INI_INSTANCE *sInstance, PSTR szItem,
                              PSTR pString, W32 wMaxSize)
{
...
*
****************************************************************************/
BOOL cdeclhmiINIWriteQuery(_INI_INSTANCE *sInstance, PSTR szItem, BOOL wState)
{
    // locate item within section
    if (!hmiINILocateItem(sInstance, szItem))
        return (_FALSE);
...
*
****************************************************************************/
BOOL cdeclhmiINIDeleteItem(_INI_INSTANCE *sInstance, PSTR szItem)
{
    PSTR pDataPtr;
    W32 wStrSize = 0;
...
*
****************************************************************************/
BOOL cdeclhmiINIDeleteSection(_INI_INSTANCE *sInstance, PSTR szSection)
{
    PSTR pDataPtr;
    PSTR pEOFPtr;
    W32 wSize;
...
*
****************************************************************************/
BOOL cdeclhmiINIAddSection(_INI_INSTANCE *sInstance, PSTR szSection)
{
    PSTR pDataPtr;
    W32 wSize;
...
*
****************************************************************************/
BOOL cdeclhmiINIAddItemString(_INI_INSTANCE *sInstance, PSTR szItem, PSTR szString, W32 wJustify)
{
    PSTR pDataPtr;
    W32 wSize;
...
*
****************************************************************************/
BOOL cdeclhmiINIAddItemDecimal(_INI_INSTANCE *sInstance,
                               PSTR szItem,
                               W32 wValue,
                               W32 wJustify,
                               W32 wRadix)
...
{
// accumulate value
wDecimal += wMultiplier[ wPlaces - 1 ] *
hmiINIGetHexIndex((BYTE)
szHexValue[ wIndex++ ] );
