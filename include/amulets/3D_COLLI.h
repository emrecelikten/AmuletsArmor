...
T_void
View3dSetExceptObject(T_word16 exceptObject);

T_void
View3dSetExceptObjectByPtr(T_objMoveStruct *p_object);

E_Boolean
View3dObjectHit(T_sword16 x, T_sword16 y, T_word16 radius);

T_word16 *
View3dGetSurroundingSectors(T_word16 *numSectors);

T_void
View3dSetMoveAccuracy(T_word16 accuracy);

T_word16
View3dGetMoveAccuracy(T_void);
