...
T_void
ButtonMouseControl(E_mouseEvent event,
                   T_word16 x,
                   T_word16 y,
...
T_void
ButtonSetData(T_buttonID buttonID, T_word32 data);
T_void
ButtonSetSubData(T_buttonID buttonID, T_word32 subdata);
T_void
...
T_void
ButtonSetCallbacks(T_buttonID buttonID, T_buttonHandler callback1, T_buttonHandler callback2);
E_buttonAction
