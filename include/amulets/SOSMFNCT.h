...
W32
sosMIDIRegisterLoopFunction(HANDLE, W32 (*)(HANDLE, BYTE, BYTE));
W32
sosMIDIRegisterBranchFunction(HANDLE, W32 (*)(HANDLE, BYTE, BYTE));
W32
sosMIDIRegisterTriggerFunction(HANDLE, W32 (*)(HANDLE, BYTE, BYTE));
...
W32
sosMIDIInitSong(PSOSMIDISONG, HANDLE *);
...
W32
sosMIDILoadDriver(W32, HANDLE, LPSTR *, LPSTR *, PSTR,
                  PSTR, DWORD *);
W32 sosMIDIUnLoadDriver(HANDLE);
W32 sosMIDISendMIDIEvent(HANDLE, W32, W32, W32, W32);
W32
sosMIDIInitDependencyList(PSONG, PSTR *);

W32 sosMIDIGetSongNotesOn(HANDLE);
W32
sosMIDIGetSongLocation(HANDLE, W32 *, W32 *, W32 *);
W32
sosMIDIGetTrackLocation(HANDLE, W32, W32 *, W32 *, W32 *);
W32
sosMIDICalculateLocation(PSONG, DWORD, W32 *, W32 *, W32 *);

W32 cdecl
far sosCBCKSendData(LPSTR, W32, W32);
W32 cdecl
far sosCBCKInit(LPSTR, W32, W32);
W32 cdecl
far sosCBCKUnInit(LPSTR, W32, W32);
W32 cdecl
far sosCBCKReset(LPSTR, W32, W32);
W32 cdecl
far sosCBCKSetInstrumentData(LPSTR, W32, W32);

W32 cdecl
far digiSendData(LPSTR, W32, W32);
W32 cdecl
far digiInit(LPSTR, W32, W32);
W32 cdecl
far digiUnInit(LPSTR, W32, W32);
W32 cdecl
far digiReset(LPSTR, W32, W32);
W32 cdecl
far digiSetInstrumentData(LPSTR, W32, W32);

W32 cdecl
far waveSendData(LPSTR, W32, W32);
W32 cdecl
far waveInit(LPSTR, W32, W32);
W32 cdecl
far waveUnInit(LPSTR, W32, W32);
W32 cdecl
far waveReset(LPSTR, W32, W32);
W32 cdecl
far waveSetInstrumentData(LPSTR, W32, W32);
VOID cdecl
far waveSampleCallback(W32, W32, W32);
...
// function prototypes
VOID cdecl
digiSampleCallback(  W32, W32, W32
);
...
extern void cdecl
sosMIDIDRVGetFuncsPtr( LPSTR, LPSTR, LPSTR ) ;
extern LPSTR cdecl
sosMIDIDRVSpecialFunction( LPSTR, LPSTR, W32 ) ;
extern W32 cdecl
xgetES(void);
extern VOID cdecl
sosMIDICode23Start( VOID );
extern VOID cdecl
sosMIDICode23End( VOID );
