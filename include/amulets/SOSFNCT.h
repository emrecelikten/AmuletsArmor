...
VOID
sosSetMemAllocFunction(PSTR ( * )(DWORD));
// NEW
VOID
sosSetMemFreeFunction(VOID ( * )(PSTR, W32));
// END
...
W32
sosDIGIInitDriver(PSOSDIGIDRIVER, HANDLE *);
W32 sosDIGIUnInitDriver(HANDLE, BOOL, BOOL);
W32
sosDIGILoadDriver(W32, HANDLE, LPSTR *, LPSTR *, PSTR, PSTR, W32 *);
W32 sosDIGIUnLoadDriver(HANDLE);
W32 sosDIGIGetDeviceCaps(HANDLE, PSOSCAPABILITIES);
PSTR
sosDIGIAllocDMABuffer(W32, DWORD *, W32 *, LPSTR *);
...
W32
sosTIMERRegisterEvent(W32, VOID ( * )(VOID),
                      HANDLE *);
...
#else
W32
sosAllocVDSPage(LPSTR *, W32 *, DWORD *);
...
extern W32 cdecl
sosDRVLockMemory     ( DWORD, DWORD ) ;
extern W32 cdecl
sosDRVUnLockMemory   ( DWORD, DWORD ) ;
extern void cdecl
sosDRVGetCapsInfo    ( LPSTR, LPSTR, _SOS_CAPABILITIES * ) ;
extern void cdecl
sosDetDRVGetCapsInfo ( LPSTR, LPSTR, _SOS_CAPABILITIES * ) ;
extern void cdecl
sosDRVGetCapsPtr     ( LPSTR, LPSTR, _SOS_CAPABILITIES * ) ;
extern void cdecl
sosDRVInit           ( LPSTR, LPSTR,
int , int , int , int , int , int ) ;
extern void cdecl
sosDRVStart          ( LPSTR, LPSTR,
int , int ) ;
extern void cdecl
sosDRVSetRate        ( LPSTR, LPSTR,
int ) ;
extern void cdecl
sosDRVSetAction      ( LPSTR, LPSTR ) ;
extern void cdecl
sosDRVStop           ( LPSTR, LPSTR ) ;
extern void cdecl
sosDRVUnInit         ( LPSTR, LPSTR ) ;
extern void cdecl
sosFillSampleStructs ( PSTR, LPSTR ) ;
extern W32 cdecl
sosDetDRVExist       ( LPSTR, LPSTR ) ;
extern W32 cdecl
sosDetDRVGetSettings ( LPSTR, LPSTR ) ;
extern W32 cdecl
sosDetDRVVerifySettings( LPSTR, W32, W32, W32, LPSTR ) ;
extern W32 cdecl
sosDIGIInitForWindows( W32 );
extern W32 cdecl
sosDIGIUnInitForWindows( W32 );
extern LPSTR cdecl
sosAllocateFarMem      ( W32, PSTR, DWORD * ) ;
extern LPSTR cdecl
sosCreateAliasCS       ( LPSTR );
extern VOID cdecl
sosFreeSelector        ( LPSTR, DWORD ) ;
extern LPSTR cdecl
sosMAKEDOSPtr          ( PSTR );
extern VOID cdecl
sosDetDRVSetEnvString  ( DWORD, PSTR ) ;
extern PSTR cdecl
sosDetDRVGetEnvString  ( DWORD );
extern VOID cdecl
sosDetDRVEnvStringInit ( LPSTR, LPSTR ) ;
extern LPSTR cdecl
sosDRVSetupCallFunctions( LPSTR, LPSTR ) ;
extern W32 cdecl
sosDRVGetFreeMemory     ( VOID );
extern W32 cdecl
sosDRVAllocVDSStruct    ( W32, W32 * , W32 * ) ;
extern W32 cdecl
sosDRVFreeVDSStruct     ( W32, W32 ) ;
extern W32 cdecl
sosDRVIsWindowsActive   ( VOID );
extern W32 cdecl
sosDRVVDSGetBuffer    ( W32 );
extern W32 cdecl
sosDRVVDSFreeBuffer   ( W32 );
extern W32 cdecl
getDS( VOID );
extern W32 cdecl
sosDRVMakeDMASelector   ( W32 );
extern W32 cdecl
sosDRVFreeDMASelector   ( W32 );

extern void cdecl
hmiDigitalMixer( PSOSDIGIDRIVER );

extern void cdecl
sosTIMERDRVInit(int wRate, void ( * )(void));
extern void cdecl
sosTIMERDRVUnInit(void);
extern void cdecl
sosTIMERDRVHandler(void);
extern void cdecl
sosTIMERDRVFHandler(void);
extern void cdecl
sosTIMERDRVEnable(void);
extern void cdecl
sosTIMERDRVDisable(void);
extern void cdecl
sosTIMERDRVCallOld(void);
extern void cdecl
sosTIMERDRVSetRate( W32 );
extern void cdecl
sosDIGITimer_Start(void);
extern void cdecl
sosDIGITimer_End(void);
extern void cdecl
sosDIGIDrv_Start(void);
extern void cdecl
sosDIGIDrv_End(void);

extern void cdecl
sosModule12Start(void);
extern void cdecl
sosModule12End(void);
extern void cdecl
sosModule13Start(void);
extern void cdecl
sosModule13End(void);
extern void cdecl
sosModule14Start(void);
extern void cdecl
sosModule14End(void);
extern void cdecl
sosModule15Start(void);
extern void cdecl
sosModule15End(void);
extern void cdecl
sosModule16Start(void);
extern void cdecl
sosModule16End(void);
