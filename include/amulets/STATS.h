...
StatsInit(T_void);
T_void
StatsSetPlayerMana(T_word16 value);
T_void
StatsSetPlayerHealth(T_word16 value);
T_void
...
T_void
StatsSetWeaponBaseDamage(T_byte8 damage);
T_void
StatsSetWeaponBaseSpeed(T_sbyte8 speed);
...
T_word32
StatsComputeCharacterChecksum(T_void);
