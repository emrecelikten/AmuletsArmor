...
T_void
MapDiffInitialize(T_word16 numSides, T_word16 numSectors);

T_void MapDiffFinish(T_void);

T_void
MapDiffSector(T_word16 sectorNum);

T_void
MapDiffSide(T_word16 sideNum);

T_void
MapDiffCreatedObject(T_3dObject *p_obj);

T_void
MapDiffDestroyingObject(T_3dObject *p_obj);

T_void
MapDiffChangeTypeObject(T_3dObject *p_obj);

T_void *
MapDiffCreateUpdateBlock(
